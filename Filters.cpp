    ...
    CSource(NAME("Virtual Cam"), lpunk, CLSID_VirtualCam)
{
    ...
    m_paStreams[0] = new CVCamStream(phr, this, L"Virtual Cam 1", 1);
    m_paStreams[1] = new CVCamStream(phr, this, L"Virtual Cam 2", 2);
}
...
// all the stuff.
//////////////////////////////////////////////////////////////////////////
CVCamStream::CVCamStream(HRESULT* phr, CVCam* pParent, LPCWSTR pPinName, int pinNum) :
